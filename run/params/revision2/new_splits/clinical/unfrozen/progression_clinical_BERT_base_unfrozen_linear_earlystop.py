...
# training_splits=training_splits[5:6]
# number_reports=number_reports[5:6]
# number_patients=number_patients[5:6]
...
training_args_tuned = TrainingArguments(
        output_dir=join(LOG_PATH,f'clinical_BERT/unfrozen/{fname}'),  # output directory
        ...
        logging_dir=join(LOG_PATH,f'clinical_BERT/unfrozen/{fname}'),  # directory for storing logs
        logging_steps=10,

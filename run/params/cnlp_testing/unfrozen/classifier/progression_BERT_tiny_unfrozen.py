...
training_args_frozen = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/unfrozen/results/tiny_frozen',fname),  # output directory
        ...
        logging_dir=join('/home/haithamelmarakeby/testing/unfrozen/logs/tiny_frozen',fname),  # directory for storing logs
        logging_steps=10,
...
training_args_unfrozen = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/unfrozen/results/tiny_unfrozen',fname),  # output directory
        num_train_epochs=3,  # total number of training epochs
        # per_device_train_batch_size=16,  # batch size per device during training
        ...
        warmup_steps=500,  # number of warmup steps for learning rate scheduler
        weight_decay=0.01,  # strength of weight decay
        logging_dir=join('/home/haithamelmarakeby/testing/unfrozen/logs/tiny_unfrozen',fname),  # directory for storing logs
        logging_steps=10,
        save_steps= 100000000,
        save_total_limit= 1,
#         fp16=True
...
feature_selection =[]
models = [bert_cnn, bert_rnn, bert_linear ]

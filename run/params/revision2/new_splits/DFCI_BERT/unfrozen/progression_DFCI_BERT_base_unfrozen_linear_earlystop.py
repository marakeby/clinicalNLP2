...
training_args_tuned = TrainingArguments(
        output_dir=join(LOG_PATH,f'dfci_bert/frozen_validation/{fname}'),  # output directory
        ...
        logging_dir=join(LOG_PATH,f'dfci_bert/frozen_validation/{fname}'),  # directory for storing logs
        logging_steps=10,

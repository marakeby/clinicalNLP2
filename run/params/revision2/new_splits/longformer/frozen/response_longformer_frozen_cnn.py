...
training_args_tuned = TrainingArguments(
        output_dir=join(LOG_PATH,f'longformer/frozen/{fname}'),  # output directory
        ...
        logging_dir=join(LOG_PATH,f'longformer/frozen/{fname}'),  # directory for storing logs
        logging_steps=10,
    
       save_steps= 10000000,
       evaluation_strategy = IntervalStrategy.STEPS, # "steps"
       eval_steps = 10000000, # Evaluation and Save happens every 100 steps

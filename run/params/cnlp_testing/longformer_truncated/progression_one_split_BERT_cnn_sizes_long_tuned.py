...
for i in training_splits:
    d = deepcopy(d_base)
    d['id'] = 'progression_IMPRESS_{}'.format(i)
...
training_args = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/longformer/results',filename),  # output directory
        ...
        logging_dir=join('/home/haithamelmarakeby/testing/longformer/logs',filename),  # directory for storing logs
        logging_steps=10,
        save_steps = 10000
    )
...
# bert_model_name= '/home/haithamelmarakeby/pretrained_models/longformer_tuned_notes'
bert_model_name='/home/haithamelmarakeby/pretrained_models_truncated/longformer/dfci_longformer_10-2021'
bert= {
    'type': 'bert',
    'id': 'BERT',

...
training_args = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/tuned_bert_cnn_frozen/results',filename),  # output directory
        ...
        logging_dir=join('/home/haithamelmarakeby/testing/tuned_bert_cnn_frozen/logs',filename),  # directory for storing logs
        logging_steps=10,
    )

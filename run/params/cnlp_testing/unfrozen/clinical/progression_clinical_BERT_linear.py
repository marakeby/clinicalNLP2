...
training_args_untuned = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/unfrozen/results/clinical_BERT',fname),  # output directory
        ...
        logging_dir=join('/home/haithamelmarakeby/testing/unfrozen/logs/clinical_BERT',fname),  # directory for storing logs
        logging_steps=10,

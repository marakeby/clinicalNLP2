...
training_args_tuned = TrainingArguments(
        output_dir=join(LOG_PATH,f'clinical_BERT/frozen{fname}'),  # output directory
        ...
        logging_dir=join(LOG_PATH,f'clinical_BERT/frozen/{fname}'),  # directory for storing logs
        logging_steps=10,

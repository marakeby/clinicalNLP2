...
training_args = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/tuned_bert_cnn_frozen_truncated/results',filename),  # output directory
        ...
        logging_dir=join('/home/haithamelmarakeby/testing/tuned_bert_cnn_frozen_truncated/logs',filename),  # directory for storing logs
        logging_steps=10,
    )

...
# training_splits=training_splits[0]
# number_reports=number_reports[0]
...
training_args_tuned = TrainingArguments(
        output_dir=join(LOG_PATH,f'bert/frozen/{fname}'),  # output directory
        ...
        logging_dir=join(LOG_PATH,f'bert/frozen/{fname}'),  # directory for storing logs
        logging_steps=10,
    
       save_steps= 100000,
       evaluation_strategy = IntervalStrategy.STEPS, # "steps"
       eval_steps = 100000, # Evaluation and Save happens every 100 steps
...
bert_model_name = mini_bert_model_name

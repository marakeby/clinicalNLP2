...
training_args = TrainingArguments(
        output_dir=join('/home/haithamelmarakeby/testing/bert_cnn_arch_size_frozen/results',filename),  # output directory
        ...
        logging_dir=join('/home/haithamelmarakeby/testing/bert_cnn_arch_size_frozen/logs',filename),  # directory for storing logs
        logging_steps=10,
    )
...
bert_model_name = bert_model_mini
